      ...
      <aside className="w-64 bg-white border-r border-gray-200 hidden md:block">
        <div className="px-6 py-4">
          <Link to="/" className="flex items-center gap-2 mb-6">
            <span className="text-lawyer font-serif font-bold text-xl">LawBuddy</span>
            <span className="text-client text-sm">Network</span>
          </Link>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-10">
        <div className="flex items-center justify-between px-4 py-3">
          <Link to="/" className="flex items-center gap-1">
            <span className="text-lawyer font-serif font-bold">LawBuddy</span>
            <span className="text-client text-xs">Network</span>
          </Link>
